...
const Cardproduct: React.FC<IProduct> = ({
	...
	<article className="card-product">
		<figure className="card-product__representation">
			...
			<p className={`card-product__badge card-product__badge${outstock ? '--red' : promotion ? '--green' : '--hidden'}`}>
		...
		<div className="card-product__discover-box">
			<Link href={`details/${id}`} passHref>
				<a className="card-product__discover" title="Découvrir ce produit">Découvrir</a>
			</Link>
		</div>
	</article>
);
